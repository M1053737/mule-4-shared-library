...
def call() {
    ...
    def response = httpRequest (
        ...
        requestBody: payload,
        customHeaders: [[name: 'Authorization', value: "Token cm9vdDoxMTYyMWVhZWFmM2E1M2U5MjhhMTg3NmViZjE5YTczNzdi"], [name: 'Content-Type', value: 'application/xml'], [name: '${crumbResponseMap.crumbRequestField}', value: '${crumbResponseMap.crumb}']]
        //quiet: true
